<?php 
    //$listings variable is available because the home.php controller populated it from the database
    //and then the function extract() was run on it in the loadView function that is running this script
    //inspect($listings);
...
?>
    ...
    <section>
      <div class="container mx-auto p-4 mt-4">
        ...
        <!-- show any success or error flash messages -->
        <?= loadPartial('message'); ?>
          ...
          <div class="rounded-lg shadow-md bg-white">
            <div class="p-4">
              ...
              <ul class="my-4 bg-gray-100 p-4 rounded">
                ...
                <li class="mb-2">
                  <strong>Salary:
                  </strong> <?= formatSalary($listing->salary) ?></li>
